;;; badliveware-font.el -*- lexical-binding: t; -*-

(add-to-list 'default-frame-alist '(font . "Fira Code Medium-10"))

(defvar +pretty-code-fira-code-font-name "Fira Code Medium"
...
(add-hook 'after-bootstrap-hook #'+pretty-code|setup-fira-ligatures)
...
(provide 'badliveware-font)
;;; badliveware-font.el ends here
